...
return static function (ContainerConfigurator $containerConfigurator): void {
    $containerConfigurator->extension('security', [
        ...
        'access_control' => [
            ...
            [
                'path' => '%sylius.security.api_admin_route%/administrators/reset-password',
                'role' => 'PUBLIC_ACCESS',
            ],
            [
                'path' => '%sylius.security.api_admin_regex%/.*',
            ...
            [
                'path' => '%sylius.security.api_shop_account_regex%/.*',
                'role' => 'ROLE_USER',
            ],
            [
                'path' => '%sylius.security.api_shop_route%/customers/token',
                'role' => 'PUBLIC_ACCESS',
            ],
            [
                'path' => '%sylius.security.api_shop_regex%/.*',
                'role' => 'PUBLIC_ACCESS',
            ],
        ],
    ]);
